...
public class NBTTagByte extends NBTBase.NBTNumber {
    ...
    public NBTTagByte() {
        try {
            this.o = ReflectionUtil.getNMSClass("NBTTagByte").newInstance();
    ...
    public NBTTagByte(long data) {
        try {
            this.o = ReflectionUtil.getNMSClass("NBTTagByte").getConstructor(long.class).newInstance(data);
    ...
    public Object getField(String field) {
        try {
            return ReflectionHelper.getField(ReflectionUtil.getNMSClass("NBTTagByte"), getNMSClass(), field);
    ...
    public Object invoke(String method) {
        try {
            return ReflectionUtil.getNMSClass("NBTTagByte")
                    .getMethod(method)
                    .invoke(getNMSClass());
    ...
    public Object getNMSClass() {
        try {
            if (o.getClass().getCanonicalName().equals(ReflectionUtil.getNMSClass("NBTTagByte").getCanonicalName())) return o;
