...
public class BaseBlockPosition implements Comparable<BaseBlockPosition> {
    ...
    public int g(BaseBlockPosition baseBlockPosition) {
        return (int) invoke("g", baseBlockPosition.toNMSClass());
    }
    ...
    public BaseBlockPosition d(BaseBlockPosition baseBlockPosition) {
        return new BaseBlockPosition(invoke("d", baseBlockPosition.toNMSClass()));
    }
    ...
    public Object getField(String field) {
        try {
            return ReflectionHelper.getField(ReflectionUtil.getNMSClass("BaseBlockPosition"), toNMSClass(), field);
