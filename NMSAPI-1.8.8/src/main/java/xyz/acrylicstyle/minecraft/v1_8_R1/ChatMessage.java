...
public class ChatMessage extends ChatBaseComponent {
    ...
    @Override
    public xyz.acrylicstyle.nmsapi.abstracts.minecraft.IChatBaseComponent addSibling(xyz.acrylicstyle.nmsapi.abstracts.minecraft.@NotNull IChatBaseComponent iChatBaseComponent) {
        return null;
    }
