...
public class PacketDataSerializer extends NMSAPI {
    ...
    public xyz.acrylicstyle.minecraft.v1_15_R1.BlockPosition c() {
        return new xyz.acrylicstyle.minecraft.v1_15_R1.BlockPosition(invoke("c"));
    }
    ...
    public xyz.acrylicstyle.minecraft.v1_15_R1.IChatBaseComponent d() {
    ...
    public xyz.acrylicstyle.minecraft.v1_15_R1.NBTTagCompound h() {
        return new NBTTagCompound(invoke("h"));
    }

    public void a(xyz.acrylicstyle.minecraft.v1_15_R1.ItemStack itemStack) { invoke("a", itemStack.getHandle()); }

    public xyz.acrylicstyle.minecraft.v1_15_R1.ItemStack i() { return new ItemStack(invoke("i")); }
