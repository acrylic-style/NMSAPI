...
public class ChatModifier extends NMSAPI {
    ...
    public xyz.acrylicstyle.minecraft.v1_15_R1.ChatClickable h() {
        return xyz.acrylicstyle.minecraft.v1_15_R1.ChatClickable.getInstance(invoke("h"));
    }

    public xyz.acrylicstyle.minecraft.v1_15_R1.ChatHoverable i() {
        return xyz.acrylicstyle.minecraft.v1_15_R1.ChatHoverable.getInstance(invoke("i"));
    }
