...
public class ReportedException extends RuntimeException {
    ...
    public ReportedException(xyz.acrylicstyle.minecraft.v1_15_R1.CrashReport crashReport) {
        try {
    ...
    public xyz.acrylicstyle.minecraft.v1_15_R1.CrashReport a() {
        return new xyz.acrylicstyle.minecraft.v1_15_R1.CrashReport(invoke("a"));
    }
