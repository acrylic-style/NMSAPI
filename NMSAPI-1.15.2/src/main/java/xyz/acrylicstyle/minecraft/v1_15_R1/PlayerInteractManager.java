...
public class PlayerInteractManager extends NMSAPI {
    ...
    public void a(xyz.acrylicstyle.minecraft.v1_15_R1.BlockPosition blockPosition, xyz.acrylicstyle.minecraft.v1_15_R1.EnumDirection enumDirection) {
        invoke("a", blockPosition.getHandle(), enumDirection.getHandle());
    }

    public void a(xyz.acrylicstyle.minecraft.v1_15_R1.BlockPosition blockPosition) {
    ...
    private boolean c(xyz.acrylicstyle.minecraft.v1_15_R1.BlockPosition blockPosition) {
        return (boolean) invoke("c", blockPosition.getHandle());
    }

    public boolean breakBlock(xyz.acrylicstyle.minecraft.v1_15_R1.BlockPosition blockPosition) {
        return (boolean) invoke("breakBlock", blockPosition.getHandle());
    }

    public boolean useItem(Object entityHuman, World world, xyz.acrylicstyle.minecraft.v1_15_R1.ItemStack itemStack) {
        try {
            return (boolean) ReflectionUtil.getNMSClass("PlayerInteractManager")
                    .getMethod("useItem", ReflectionUtil.getNMSClass("EntityHuman"), World.CLASS, xyz.acrylicstyle.minecraft.v1_15_R1.ItemStack.CLASS)
    ...
    public boolean interact(Object entityHuman, World world, xyz.acrylicstyle.minecraft.v1_15_R1.ItemStack itemStack, xyz.acrylicstyle.minecraft.v1_15_R1.BlockPosition blockPosition, xyz.acrylicstyle.minecraft.v1_15_R1.EnumDirection enumDirection, float f, float f1, float f2) {
        try {
            return (boolean) ReflectionUtil.getNMSClass("PlayerInteractManager")
