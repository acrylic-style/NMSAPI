...
public class WorldData extends NMSAPI {
    ...
    public static final xyz.acrylicstyle.minecraft.v1_15_R1.EnumDifficulty a = xyz.acrylicstyle.minecraft.v1_15_R1.EnumDifficulty.NORMAL;

    public static final xyz.acrylicstyle.minecraft.v1_15_R1.EnumDifficulty NORMAL_DIFFICULTY = xyz.acrylicstyle.minecraft.v1_15_R1.EnumDifficulty.NORMAL; // NMSAPI - OBFHelper
    ...
    public WorldData(xyz.acrylicstyle.minecraft.v1_15_R1.NBTTagCompound tag) {
    ...
    public xyz.acrylicstyle.minecraft.v1_15_R1.NBTTagCompound a() {
        return new xyz.acrylicstyle.minecraft.v1_15_R1.NBTTagCompound(invoke("a"));
    }

    public xyz.acrylicstyle.minecraft.v1_15_R1.NBTTagCompound a(xyz.acrylicstyle.minecraft.v1_15_R1.NBTTagCompound tag) {
        return new xyz.acrylicstyle.minecraft.v1_15_R1.NBTTagCompound(invoke("a", tag.getHandle()));
    }

    public void a(xyz.acrylicstyle.minecraft.v1_15_R1.NBTTagCompound tag, xyz.acrylicstyle.minecraft.v1_15_R1.NBTTagCompound tag2) { // NMSAPI - change private to public
    ...
    public xyz.acrylicstyle.minecraft.v1_15_R1.NBTTagCompound i() {
    ...
    public xyz.acrylicstyle.minecraft.v1_15_R1.GameRules x() {
    ...
    public xyz.acrylicstyle.minecraft.v1_15_R1.EnumDifficulty getDifficulty() {
        return xyz.acrylicstyle.minecraft.v1_15_R1.EnumDifficulty.valueOf(getField("z"));
    }
