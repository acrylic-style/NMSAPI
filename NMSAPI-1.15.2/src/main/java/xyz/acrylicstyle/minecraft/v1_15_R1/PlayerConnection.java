...
public class PlayerConnection extends NMSAPI {
    ...
    private final xyz.acrylicstyle.minecraft.v1_15_R1.MinecraftServer minecraftServer;
    public xyz.acrylicstyle.minecraft.v1_15_R1.NetworkManager networkManager;

    public PlayerConnection(@NotNull xyz.acrylicstyle.minecraft.v1_15_R1.EntityPlayer player) {
        super(player.__playerConnection, "PlayerConnection");
        this.player = player;
        this.minecraftServer = player.server;
        this.networkManager = new xyz.acrylicstyle.minecraft.v1_15_R1.NetworkManager(getField("networkManager"));
    }

    public PlayerConnection(xyz.acrylicstyle.minecraft.v1_15_R1.MinecraftServer minecraftServer, xyz.acrylicstyle.minecraft.v1_15_R1.NetworkManager networkManager, EntityPlayer entityPlayer) {
    ...
    public xyz.acrylicstyle.minecraft.v1_15_R1.NetworkManager a() {
    ...
    public void disconnect(xyz.acrylicstyle.minecraft.v1_15_R1.IChatBaseComponent iChatBaseComponent) {
        method("disconnect", xyz.acrylicstyle.minecraft.v1_15_R1.IChatBaseComponent.CLASS).invokeObj(getHandle(), iChatBaseComponent.getHandle());
    }
    ...
    public void a(xyz.acrylicstyle.minecraft.v1_15_R1.IChatBaseComponent iChatBaseComponent) {
