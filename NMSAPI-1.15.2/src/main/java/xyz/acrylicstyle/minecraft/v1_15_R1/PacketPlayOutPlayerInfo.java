...
public class PacketPlayOutPlayerInfo extends NMSAPI implements Packet<PacketListenerPlayOut> {
    ...
    public PacketPlayOutPlayerInfo(EnumPlayerInfoAction paramEnumPlayerInfoAction, xyz.acrylicstyle.minecraft.v1_15_R1.EntityPlayer... paramVarArgs) {
    ...
    public static class PlayerInfoData extends NMSAPI {
        ...
        private final xyz.acrylicstyle.minecraft.v1_15_R1.EnumGamemode c = xyz.acrylicstyle.minecraft.v1_15_R1.EnumGamemode.valueOf(((Enum<?>) getField("c")).name());
        private final GameProfile d = new GameProfile(getField("d"));
        private final xyz.acrylicstyle.minecraft.v1_15_R1.IChatBaseComponent e = new ChatComponentText(getField("e"));

        public PlayerInfoData(PacketPlayOutPlayerInfo this$0, GameProfile gameProfile, int paramInt, xyz.acrylicstyle.minecraft.v1_15_R1.EnumGamemode paramEnumGameMode, xyz.acrylicstyle.minecraft.v1_15_R1.IChatBaseComponent paramIChatBaseComponent) {
        ...
        public xyz.acrylicstyle.minecraft.v1_15_R1.EnumGamemode c() { return c; }

        public EnumGamemode getGameMode() { return c; } // NMSAPI - OBFHelper

        public xyz.acrylicstyle.minecraft.v1_15_R1.IChatBaseComponent d() { return e; }
