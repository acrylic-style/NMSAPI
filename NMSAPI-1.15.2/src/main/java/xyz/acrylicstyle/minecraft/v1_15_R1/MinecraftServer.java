...
public abstract class MinecraftServer extends NMSAPI implements Runnable, ICommandListener, IAsyncTaskHandler {
    ...
    public xyz.acrylicstyle.minecraft.v1_15_R1.GameRules getGameRules() {
    ...
    public xyz.acrylicstyle.minecraft.v1_15_R1.IChatBaseComponent getS() {
    ...
    public static MinecraftServer newInstance(Object o) {
        ...
        return new MinecraftServer(o) {
            ...
            @Override
            public xyz.acrylicstyle.minecraft.v1_15_R1.IChatBaseComponent getScoreboardDisplayName() {
                return null;
            }
