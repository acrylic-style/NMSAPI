...
public class CrashReportSystemDetails extends NMSAPI {
    ...
    public static String a(double paramDouble1, double paramDouble2, double paramDouble3) {
        return String.format("%.2f,%.2f,%.2f - %s", paramDouble1, paramDouble2, paramDouble3, a(new xyz.acrylicstyle.minecraft.v1_15_R1.BlockPosition(paramDouble1, paramDouble2, paramDouble3)));
    }

    public static String a(xyz.acrylicstyle.minecraft.v1_15_R1.BlockPosition paramBlockPosition) {
    ...
    public static void a(CrashReportSystemDetails crashReportSystemDetails, xyz.acrylicstyle.minecraft.v1_15_R1.BlockPosition blockPosition, Object paramBlock, int paramInt) {
        try {
            ReflectionUtil
