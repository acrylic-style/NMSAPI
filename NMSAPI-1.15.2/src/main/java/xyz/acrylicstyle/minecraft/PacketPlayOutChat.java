...
public class PacketPlayOutChat extends NMSAPI implements Packet<PacketListenerPlayOut> {
    ...
    private static Object callCtor(IChatBaseComponent iChatBaseComponent, byte b0) {
        try {
            return CLASS.getConstructor(IChatBaseComponent.CLASS, byte.class).newInstance(iChatBaseComponent, b0);
